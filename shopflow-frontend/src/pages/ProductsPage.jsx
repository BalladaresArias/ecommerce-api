  ...
  return (
    <div style={{ minHeight: '100vh', padding: '60px 0' }}>
      <div className="container">
        ...
        {/* Filtros */}
        <div style={{ display: 'flex', gap: '16px', marginBottom: '48px', flexWrap: 'wrap', alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
            <button
              ...
              style={{
                padding: '10px 20px', fontSize: '11px', letterSpacing: '1px', border: '1px solid',
              ...
              <div key={product.id} className="card"
                ...
                <div style={{ height: '240px', background: 'var(--bg-primary)', overflow: 'hidden', position: 'relative' }}>
                  {product.image_url ? (
                    ...
                    <div style={{ width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'var(--text-muted)', fontFamily: 'var(--font-display)', fontSize: '56px' }}>✦</div>
                  )}
                  {product.stock <= 5 && product.stock > 0 && (
                    <div style={{ position: 'absolute', top: '12px', left: '12px', background: '#c0392b', color: '#fff', padding: '4px 10px', fontSize: '10px', fontWeight: '700' }}>ÚLTIMAS UNIDADES</div>
                  )}
                  {product.stock === 0 && (
                ...
                <div style={{ padding: '20px' }}>
                  ...
                  <h3 style={{ fontFamily: 'var(--font-display)', fontSize: '20px', fontWeight: '400', marginBottom: '8px' }}>{product.name}</h3>
                  <p style={{ color: 'var(--text-secondary)', fontSize: '12px', lineHeight: '1.6', marginBottom: '20px', display: '-webkit-box', WebkitLineClamp: 2, WebkitBoxOrient: 'vertical', overflow: 'hidden' }}>
                    {product.description}
                  </p>
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                    <div>
                      ...
                      <p style={{ color: 'var(--text-muted)', fontSize: '10px' }}>Stock: {product.stock}</p>
                    </div>
                    <button
                      className="btn-gold"
        ...
        {totalPages > 1 && (
          <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '8px', marginTop: '48px' }}>
            <button
              ...
              style={{ padding: '8px 20px', opacity: page === 1 ? 0.4 : 1 }}
            >
              ← Anterior
            </button>
            ...
            <button
              ...
              className="btn-outline"
              style={{ padding: '8px 20px', opacity: page === totalPages ? 0.4 : 1 }}
            >
              Siguiente →
            </button>
          </div>
